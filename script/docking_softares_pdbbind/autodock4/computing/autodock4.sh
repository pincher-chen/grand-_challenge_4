...
mgl_dir=/WORK/app/mgltools/1.5.6/MGLToolsPckgs/AutoDockTools/Utilities24/
...
#step 1. create pdbqt files from vina
#  mkdir -p ${data_dir}/${i}
  cd ${data_dir}/${i}
 ...
 # $MGL_ROOT/bin/pythonsh  $pdbqt_prepare/prepare_receptor4.py -U nphs_lps_waters -r ${data_dir}/${i}/${i}_protein_addH.pdb -o ${data_dir}/${i}/${i}_protein.pdbqt
...
#step 2. prepare gpf file
  ...
  pythonsh ${mgl_dir}/prepare_gpf4.py -p gridcenter="${center_x},${center_y},${center_z}"  -l ${data_dir}/${i}/${i}_ligand.pdbqt -r ${data_dir}/${i}/${i}_protein.pdbqt -o ${data_dir}/${i}/${i}_docking.gpf
...
#step 3. prepare dpf file
  ...
  pythonsh ${mgl_dir}/prepare_dpf42.py -l ${data_dir}/${i}/${i}_ligand.pdbqt -r ${data_dir}/${i}/${i}_protein.pdbqt -o ${data_dir}/${i}/${i}_docking.dpf -p ga_run=10
...
#step 6. get score
  pythonsh ${mgl_dir}/summarize_results4.py -d ${data_dir}/${i} -o ${data_dir}/${i}/summary_result.txt
  pythonsh ${mgl_dir}/write_conformations_from_dlg.py -d ${data_dir}/${i}/${i}_docking.dlg
